...
"Hepatitis, HIV and other co-infections", "Python, data wrangling, infographics, statistics, R", "In the crazy world of data, we are analyzing patient laboratory test results about Hepatitis B infections and in part trying to show how this very infectious but preventable virus is neglected.  Also a meta-analysis on the serology of hepatitis B in Africa, and we made an interactive dashboard of this (https://hbv-geo.shinyapps.io/oxafricahbv/).",
...
"Pathogen Research Laboratory", "Screening, surveillance, metagenomics", "\\begin{itemize}
  \\item Screening of mosquitoes for arboviruses in South Africa.
  ...
  \\item Development of MinION sequencing technique.
...
\begin{description}
  \item$\bullet$ Main and co- supervision for Honours and M. students.
    \item\subitem$\circ$ Co-supervisor for M.Med.Sc student. Detection and characterization of alphaviruses in the 
Bloemfontein region, Free State.
    \item\subitem$\circ$ Co-supervisor for M.Med.Sc student. Development of Non-Species-Specific ELISA and RT-qPCR for Serosurveillance and
Detection of Crimean-Congo Haemorrhagic Fever Virus.
