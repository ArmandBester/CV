...
jobtitle: Passionate about interdisciplinary science
sidebar:
  image: portrait.png
  bullets:
...
The rapid growth of scientific data throughout my career highlighted the increasing importance of computational approaches in modern research. I have always been fascinated by algorithms and programming, and the intersection of informatics and science is where my interests lie. I enjoy developing computational solutions to extract meaningful insights from complex biological data, and I value the opportunity to contribute to a diverse range of interdisciplinary research projects. \
...
"Medical Scientist", "National Health Laboratory Services", "Jan 2015 - Jul 2021", "",
...
"Sequencing, ecology and surveillance", "Data generation and analysis. Sequencing, bash, python", "The combination of next-generation sequencing technologies and bioinformatics provides opportunities to collaborate on a diverse range of research projects. These include viral surveillance, characterising the virome and microbiome of the infant gut, investigating fungal communities in urban water systems, and applying sequencing-based approaches to a wide variety of biological and public health research questions.",

"Hepatitis, HIV and other co-infections", "Python, data wrangling, infographics, statistics, R", "Large-scale patient laboratory data are analysed using Python and R to investigate the epidemiology of Hepatitis B virus (HBV) infection, including HIV and Hepatitis C virus (HCV) co-infections. The work aims to better understand the burden of this highly infectious yet vaccine-preventable disease. In parallel, a systematic review and meta-analysis of HBV serology across Africa has been undertaken, accompanied by the development of an interactive dashboard to visualise and explore the findings. (https://hbv-geo.shinyapps.io/oxafricahbv/).",
...
"Pathogen Research Laboratory", "Screening, surveillance, metagenomics", "\\begin{itemize}
  \\item Screening of vectors for arboviruses in South Africa.
  \\item Screening cattle and sheep sera for evidence of infection with arboviruses identified in Bloemfontein.
  \\item Next Generation Sequencing (NGS) for complete genome determination of arboviruses and zoonotic pathogens.
  \\item Development of Oxford NanoPore sequencing techniques.
  \\item Bayesian phylogeography of global Crimean-Congo hemorrhagic fever virus isolates.
  \\item Arboviruses as a cause of neurological disease in humans.
  \\item Detection and whole genome characterization of Jingmen tick virus from wild-caught ticks (Acari: Ixodidae) in the Free State and Eastern Cape Province South Africa.
\\end{itemize}"
) |>
...
\begin{description}
  \item$\bullet$ Main and co- supervision for Honours and M. students and collaborations. 
    \item\subitem$\circ$ Co-supervisor for M.Med.Sc student. Detection and characterization of alphaviruses in the Bloemfontein region, Free State.
    \item\subitem$\circ$ Co-supervisor for M.Med.Sc student. Development of Non-Species-Specific ELISA and RT-qPCR for Serosurveillance and Detection of Crimean-Congo Haemorrhagic Fever Virus.
    \item\subitem$\circ$ Collaborator on Ph.D project. Circulation and characterization of known and novel orthonairoviruses transmitted by ixodid ticks in three provinces of South Africa.
    \item\subitem$\circ$ Collaborator on Ph.D project. Genomic characterization of Mycobacterium spp. Isolated from cattle using long-read Oxford nanopore sequencing.
    \item\subitem$\circ$ Collaborator on Ph.D project. Determination of tick diversity and screening for viral infections in ticks of livestock from the Eastern Cape and Free State Provinces of South Africa.
    \item\subitem$\circ$ Co-supervisor (Norwegian University of life sciences) M.Sc student. Forecasting load in an operational centralised microgrid.
    \item\subitem$\circ$ Main supervisor for Honours student developing an HIV integrase drug resistance assay.
    \item\subitem$\circ$ Equally shared supervisor for two Honours students on: A simple and rapid approach to prepare Sindbis and West Nile viral RNA controls for differentiation between positive samples and laboratory contamination.
    \item\subitem$\circ$ Co-supervisor for M. Med student looking at the influence of volumes on dry blood spot samples for infant HIV diagnostics.
    \item\subitem$\circ$ Co-supervision of M. Med student looking at HBV drug resistance and viral loads.
    \item\subitem$\circ$ Collaborator on M. Med project. Hepatitis B seroprevalence amongst HIV infected individuals in the Free State, South Africa
    \item\subitem$\circ$ Collaborator on M. Med project. HBV viral load and drug resistance among HIV-HBV co-infected patients: A cross-sectional study in central South Africa.
    ...
    \item\subitem$\circ$ Screening black South African females with Type 2 Diabetes Mellitus for mutations in the peroxisome proliferator-activated receptor gamma gene.
    \item\subitem$\circ$ Methylation analysis of type two diabetes mellitus (T2DM) genes in cases and controls from central South Africa.
    \item\subitem$\circ$ SOCS3 gene DNA methylation analysis methods to investigate inflammation associated with HIV infection.
...
- Arbovirus surveillance detects mosquito-borne viruses in central South Africa. **Virology**. 2025. https://doi.org/10.1016/j.virol.2025.110668

- Identification of arboviruses in mosquito populations in KwaZulu-Natal, South Africa and the first record of *Wyeomyia mitchellii* in the Old World. **PLOS Neglected Tropical Diseases**. 2025. 19(8): e0013093. https://doi.org/10.1371/journal.pntd.0013093


- Hepatitis B seroprevalence among HIV-positive adults in the Free State, South Africa. **S Afr J HIV Med.** 2025; 26(1), a1654. https://doi.org/10.4102/sajhivmed.v26i1.1654

- Culture-Dependent and -Independent Wastewater Surveillance for Multiple Pathogenic Yeasts. **Journal of Fungi**. 2025; 11(2):86. https://doi.org/10.3390/jof11020086

- Biofilms on urban aquatic plastic pollution as a reservoir for pathogenic yeasts. **Journal of Water and Health.** 2024 Oct https://doi.org/10.2166/wh.2024.133.
